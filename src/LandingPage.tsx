...
const tools = [
  ...
  { id: 'monster', name: 'Clutter Monster',        icon: Flame,          color: 'gold',    emoji: '⚔️', description: 'Battle the mess in a 10-minute cleanup quest',                 keyword: 'gamified cleanup timer' },
]
...
function LandingPage({ onSelectTool }: { onSelectTool: (toolId: any) => void }) {
  ...
  const toolMapping: Record<string, string> = {
    ...
    'Cognitive Bias Test': 'bias', 'Should I Buy It': 'buyit', 'Sorting Hat': 'sortinghat', 'Should I Keep It?': 'keepit', 'Toy Farewell': 'farewell', 'Clutter Monster': 'monster',
  }
        ...
        <div id="how-it-helps" className="w-full px-4 py-16 scroll-mt-20">
          ...
          <div className="flex flex-wrap justify-center gap-8 py-6 border-y border-cream-300 mt-12">
            <div className="text-center">
              <p className="text-3xl font-bold font-display text-secondary-500">20</p>
