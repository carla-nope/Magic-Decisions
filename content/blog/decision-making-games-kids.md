...
## Game 2: Would You Rather (Decision Edition)
...
## Game 3: The 10-Second Challenge

**How to play:** Set a timer for 10 seconds. Give a decision to make. Whoever decides first wins the round.


**Why it works:** It trains speed. Kids discover they can decide faster than they thought. The time pressure makes it exciting.


**Variation:** Reverse it. Whoever takes longest to decide loses the round and has to do a small challenge (sing a song, do five jumps).


## Game 4: The Random Scavenger Hunt

**How to play:** Put household items on cards. Draw a card and decide: "Use it to [silly purpose]" or "Trade it for [something else]."


**Example:** Draw a spoon. "Use it to rake leaves or trade it for a fork." The randomness forces quick decisions.


**Why it works:** It breaks the idea that decisions need lots of thought. With absurd scenarios, kids learn to just pick something and run with it.


## Game 5: The Decision Dice

**How to play:** Write decision scenarios on paper and roll dice to pick which one to solve. Or use a spin wheel with scenarios.
...
**How to play:** Make up a restaurant with five menu items. Everyone orders within 30 seconds. If you don't order, the group picks for you.


**Why it works:** It mimics real-world decision pressure in a fun, consequence-free setting. Plus, it's hilarious to watch people panic when time runs out.


## Game 7: Yes/No Relay

**How to play:** One person asks rapid-fire yes/no questions. The other must answer in under 3 seconds.
